# kgateway (Gloo Gateway) Sandbox

Local k3d sandbox for testing kgateway (formerly Gloo Gateway OSS).
...
2. **kgateway** - Installs Gloo Gateway OSS via Helm into `gloo-system` namespace on each cluster
...
├── scripts/
│   ├── cluster-setup-k3d-gg-everything.sh    # Full stack deployment
